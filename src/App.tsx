...
const BannerSkeleton = () => (
  <div className="w-full aspect-[1280/720] bg-gray-200 animate-pulse rounded-2xl" />
);
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 relative">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-atl-orange mb-2">
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            {authMode === 'signup' && (
              <div>
                ...
                <input 
                  ...
                  className="w-full border-2 border-gray-100 rounded-lg py-3 px-4 focus:border-atl-orange outline-none transition-colors"
                />
              </div>
            )}
            <div>
            ...
            <button 
              type="submit"
              className="w-full bg-atl-orange text-white py-3 rounded-lg font-bold hover:bg-orange-700 transition-colors shadow-lg shadow-atl-orange/20"
            >
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            {authMode === 'login' ? (
              <p>Don't have an account? <span onClick={() => toggleAuthMode('signup')} className="text-atl-orange font-bold cursor-pointer hover:underline">Sign Up</span></p>
            ) : (
              <p>Already have an account? <span onClick={() => toggleAuthMode('login')} className="text-atl-orange font-bold cursor-pointer hover:underline">Login</span></p>
            )}
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <header className="sticky top-0 z-50 glass-header transition-all duration-300">
        <div className="bg-atl-bg py-1 border-b border-gray-100 hidden md:block">
          <div className="atl-container flex justify-between text-xs">
        ...
        <div className="py-4 bg-white">
          <div className="atl-container flex items-center gap-8">
            <div 
              onClick={() => { setSearchQuery(''); setCurrentView('home'); }}
              className="flex items-center gap-3 cursor-pointer group shrink-0"
            >
              <div className="relative">
                <div className="w-12 h-12 bg-gradient-to-br from-atl-orange to-orange-600 rounded-2xl flex items-center justify-center text-white shadow-xl shadow-orange-200 group-hover:rotate-12 transition-all duration-500 overflow-hidden">
            ...
            <div className="flex-1 relative">
              ...
              />
              <button className="absolute right-0 top-0 h-full bg-atl-orange text-white px-4 rounded-r-sm">
                <Search size={20} />
              </button>
            </div>
            <div className="flex items-center gap-6 text-gray-600">
              <div 
                className="flex items-center gap-2 cursor-pointer hover:text-atl-orange"
              ...
              <div 
                className="relative cursor-pointer hover:text-atl-orange"
                onClick={() => setIsCartOpen(true)}
              >
                <ShoppingCart size={24} />
                {cartCount > 0 && (
                  <span className="absolute -top-2 -right-2 bg-atl-orange text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center">
                    {cartCount}
                  </span>
                )}
              </div>
      ...
      {/* Main Content */}
      <main className="flex-1 atl-container py-6">
        {currentView === 'home' && (
          <>
            {/* Hero Section */}
            {!searchQuery && (
                    ...
                    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-3 z-10">
                      {(siteConfig.heroBanners || [siteConfig.heroBanner]).map((_, idx) => (
                        <button
                          ...
                          className={`h-1.5 rounded-full transition-all duration-500 ${currentBannerIndex === idx ? 'bg-atl-orange w-8 shadow-[0_0_10px_rgba(248,86,6,0.6)]' : 'bg-white/40 w-3 hover:bg-white/60'}`}
                        />
                      ))}
                    </div>
            ...
            <section className="mb-16">
              <div className="flex justify-between items-end mb-10">
                <div className="flex items-center gap-4">
                  <div className="h-10 w-2 bg-atl-orange rounded-full shadow-lg shadow-orange-200"></div>
                  <div>
                ...
                <button className="text-atl-orange text-sm font-black hover:underline tracking-widest uppercase flex items-center gap-2 group">
                  SHOP MORE 
                  ...
                  products
                    ...
                    >
                      <div className="aspect-square overflow-hidden relative img-zoom-container">
                        ...
                        />
                        {product.discount && (
                          <div className="absolute top-3 left-3 bg-atl-orange text-white text-[10px] font-black px-2.5 py-1 rounded-full shadow-lg z-10">
                            -{product.discount}%
                          </div>
                        )}
                        ...
                        <div className="absolute bottom-3 left-3 right-3 translate-y-12 group-hover:translate-y-0 transition-transform duration-500 z-10">
                          <button 
                            ...
                            className="w-full py-2 bg-atl-orange text-white text-xs font-black rounded-xl shadow-xl hover:bg-orange-600 transition-colors uppercase tracking-wider"
                          >
                            Add to Cart
                          </button>
                        </div>
          ...
          >
            <div className="p-4 border-b flex items-center gap-2">
              <button 
                ...
                className="text-gray-500 hover:text-atl-orange flex items-center gap-1 text-sm font-medium glow-button"
              >
              ...
              <div className="flex-1 flex flex-col">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    {selectedProduct.originalPrice && (
                      <div className="flex items-center gap-2 text-lg text-gray-400">
                        ...
                        <span className="bg-orange-100 text-atl-orange px-2 py-0.5 rounded text-sm font-bold">
                  ...
                  <div className="flex items-center gap-2 mb-6">
                    ...
                    <button className="ml-auto p-2 hover:bg-gray-100 rounded-full transition-colors text-gray-400 hover:text-atl-orange">
                      <Share2 size={20} />
                    </button>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-4 mb-8">
                    <div className="flex items-center gap-2 text-xs font-bold text-gray-500 bg-gray-50 px-3 py-2 rounded-lg border border-gray-100">
                      <Truck size={16} className="text-atl-orange" />
                      FREE DELIVERY
                    </div>
                    <div className="flex items-center gap-2 text-xs font-bold text-gray-500 bg-gray-50 px-3 py-2 rounded-lg border border-gray-100">
                      <ShieldCheck size={16} className="text-atl-orange" />
                      AUTHENTIC PRODUCT
                    </div>
                    <div className="flex items-center gap-2 text-xs font-bold text-gray-500 bg-gray-50 px-3 py-2 rounded-lg border border-gray-100">
                      <RotateCcw size={16} className="text-atl-orange" />
                      7 DAYS RETURN
                    </div>
                  </div>
                    ...
                    <div className="mb-8">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedProduct.sizes.map(size => (
                          <span key={size} className="px-4 py-2 bg-white border-2 border-gray-100 rounded-lg text-sm font-bold hover:border-atl-orange cursor-pointer transition-all">
                            {size}
                          </span>
                        ))}
                      </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <button 
                    ...
                    className="flex-1 bg-atl-orange text-white py-4 rounded-xl font-bold text-lg hover:bg-orange-700 transition-all transform active:scale-[0.98] flex items-center justify-center gap-2 shadow-lg shadow-atl-orange/20"
                  >
                    <ShoppingBag size={24} />
                    BUY NOW
                  </button>
        ...
        {currentView === 'checkout' && checkoutItem && (
          ...
          >
            <div className="p-6 bg-atl-orange text-white flex justify-between items-center">
            ...
            <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-8">
                <div>
                  <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
                    <ShoppingBag className="text-atl-orange" />
                    Order Summary
                  </h3>
                  <div className="flex gap-4 bg-gray-50 p-4 rounded-xl border border-gray-100">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-atl-orange font-bold text-xl mt-1">৳{checkoutItem.price}</p>
                ...
                <div>
                  <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
                    <User className="text-atl-orange" />
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-2 mb-2">
                      <button 
                        ...
                        className={`flex-1 py-2 text-xs font-bold rounded-lg border-2 transition-all ${deliveryLocation === 'inside' ? 'border-atl-orange bg-orange-50 text-atl-orange' : 'border-gray-100 text-gray-500'}`}
                      >
                        INSIDE DHAKA (৳{siteConfig.deliveryFeeInside || 75})
                      </button>
                      <button 
                        onClick={() => setDeliveryLocation('outside')}
                        className={`flex-1 py-2 text-xs font-bold rounded-lg border-2 transition-all ${deliveryLocation === 'outside' ? 'border-atl-orange bg-orange-50 text-atl-orange' : 'border-gray-100 text-gray-500'}`}
                      >
                    ...
                    <input 
                      ...
                      className="w-full p-3 border rounded-lg focus:ring-1 focus:ring-atl-orange outline-none" 
                      value={shippingName}
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
                    <Lock className="text-atl-orange" />
                    Payment Method
                  </h3>
                  <div className="grid grid-cols-1 gap-3">
                    <button 
                      onClick={() => setPaymentMethod('bkash')}
                      className={`p-4 border-2 rounded-xl flex items-center justify-between transition-all ${paymentMethod === 'bkash' ? 'border-atl-orange bg-orange-50' : 'border-gray-100 hover:border-gray-200'}`}
                    >
                      ...
                      {paymentMethod === 'bkash' && <div className="w-5 h-5 bg-atl-orange rounded-full flex items-center justify-center text-white"><Plus size={14} className="rotate-45" /></div>}
                    </button>
                    <button 
                      onClick={() => setPaymentMethod('nagad')}
                      className={`p-4 border-2 rounded-xl flex items-center justify-between transition-all ${paymentMethod === 'nagad' ? 'border-atl-orange bg-orange-50' : 'border-gray-100 hover:border-gray-200'}`}
                    >
                      <div className="flex items-center gap-3">
                      ...
                      {paymentMethod === 'nagad' && <div className="w-5 h-5 bg-atl-orange rounded-full flex items-center justify-center text-white"><Plus size={14} className="rotate-45" /></div>}
                    </button>
                    ...
                    {(paymentMethod === 'bkash' || paymentMethod === 'nagad') && (
                      <motion.div 
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        className="p-4 bg-orange-50 rounded-xl border border-atl-orange/20 space-y-3"
                      >
                        ...
                        <input 
                          ...
                          className="w-full p-3 border border-atl-orange/30 rounded-lg focus:ring-1 focus:ring-atl-orange outline-none bg-white" 
                          value={transactionId}
                    ...
                    <button 
                      ...
                      className={`p-4 border-2 rounded-xl flex items-center justify-between transition-all ${paymentMethod === 'cod' ? 'border-atl-orange bg-orange-50' : 'border-gray-100 hover:border-gray-200'}`}
                    >
                      <div className="flex items-center gap-3">
                      ...
                      {paymentMethod === 'cod' && <div className="w-5 h-5 bg-atl-orange rounded-full flex items-center justify-center text-white"><Plus size={14} className="rotate-45" /></div>}
                    </button>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-2xl space-y-4">
                  ...
                  <div className="border-t pt-4 flex justify-between text-xl font-bold">
                    <span>Total</span>
                    <span className="text-atl-orange">৳{checkoutItem.price + (deliveryLocation === 'inside' ? (siteConfig.deliveryFeeInside || 75) : (siteConfig.deliveryFeeOutside || 130))}</span>
                  </div>
                  <button 
                    ...
                    onClick={async () => {
                      ...
                      const newOrder: Order = {
                        ...
                        paymentMethod: paymentMethod as 'bkash' | 'nagad' | 'cod',
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            >
              ...
              <button 
                ...
                className="w-full bg-atl-orange text-white py-4 rounded-xl font-bold text-lg hover:bg-orange-700 transition-all glow-button"
              >
                Back to Home
              </button>
            </motion.div>
      ...
      <footer className="bg-white border-t py-12 pb-24">
        ...
        <div className="mt-12 pt-8 border-t border-gray-100 atl-container flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-sm text-gray-400">
            © {new Date().getFullYear()} 
            <span className="ml-1 px-2 py-0.5 bg-atl-orange/10 text-atl-orange font-black italic rounded-md border border-atl-orange/20 shadow-sm">
              {siteConfig.siteName}
            </span>. All Rights Reserved.
            <p className="mt-2 font-bold text-gray-500 flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 bg-atl-orange rounded-full"></span>
              Website designer <span className="text-atl-orange">Mdtarek</span>
            </p>
          </div>
          <button 
            ...
            >
              <div className="p-4 border-b flex items-center justify-between bg-white sticky top-0 z-10">
                <div className="flex items-center gap-2">
                  <ShoppingCart className="text-atl-orange" />
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                {cart.length === 0 ? (
                  <div className="h-full flex flex-col items-center justify-center text-gray-400 space-y-4">
                    ...
                    <button 
                      onClick={() => setIsCartOpen(false)}
                      className="bg-atl-orange text-white px-8 py-2 rounded-full font-bold hover:bg-orange-700 transition-colors"
                    >
                      Start Shopping
                    </button>
                  </div>
                    ...
                    <div key={item.id} className="flex gap-4 bg-gray-50 p-3 rounded-xl group">
                      ...
                      <div className="flex-1 flex flex-col justify-between py-1">
                        <div>
                          ...
                          <p className="text-atl-orange font-bold">৳{item.price}</p>
                        </div>
                        <div className="flex items-center justify-between">
              ...
              {cart.length > 0 && (
                <div className="p-6 border-t bg-white space-y-4">
                  <div className="flex justify-between items-center text-lg">
                    ...
                    <span className="font-bold text-atl-orange text-2xl">৳{cartTotal}</span>
                  </div>
                    <button 
                      onClick={() => {
                        if (cart.length > 0) {
                      ...
                      className="w-full bg-atl-orange text-white py-4 rounded-xl font-bold text-lg hover:bg-orange-700 transition-colors shadow-lg shadow-atl-orange/20"
                    >
                      PROCEED TO CHECKOUT
                    </button>
      ...
      <AnimatePresence>
        {isAdminOpen && (
          <motion.div 
            ...
            exit={{ y: '100%' }}
            transition={{ type: 'spring', damping: 25, stiffness: 200 }}
            className="fixed bottom-0 left-0 right-0 bg-white border-t-2 border-atl-orange shadow-2xl z-50 max-h-[80vh] overflow-y-auto"
          >
            <div className="atl-container py-6 relative">
              <button 
              ...
              {!isAdminAuthenticated ? (
                <div className="max-w-md mx-auto text-center py-12">
                  <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4 text-atl-orange">
                    <Lock size={32} />
                  </div>
                  ...
                  <form onSubmit={handleAdminLogin} className="space-y-4">
                    <input 
                      ...
                      className="w-full border-2 border-gray-200 rounded-lg py-3 px-4 focus:border-atl-orange outline-none transition-colors"
                    />
                    {error && <p className="text-red-500 text-sm">{error}</p>}
                    <button 
                      type="submit"
                      className="w-full bg-atl-orange text-white py-3 rounded-lg font-bold hover:bg-orange-700 transition-colors"
                    >
                      প্রবেশ করুন
                    </button>
                  </form>
                ...
                <div className="space-y-8">
                  <div className="flex justify-between items-center border-b pb-4">
                    <h2 className="text-2xl font-bold flex items-center gap-2">
                      <Settings className="text-atl-orange" />
                      Control Panel
                    </h2>
                    <button 
                  ...
                  <div className="flex gap-4 border-b overflow-x-auto">
                    <button 
                      ...
                      className={`pb-2 px-4 font-bold text-sm transition-all border-b-2 whitespace-nowrap ${activeAdminTab === 'products' ? 'border-atl-orange text-atl-orange' : 'border-transparent text-gray-400 hover:text-gray-600'}`}
                    >
                      Products
                    </button>
                    <button 
                      onClick={() => setActiveAdminTab('orders')}
                      className={`pb-2 px-4 font-bold text-sm transition-all border-b-2 whitespace-nowrap ${activeAdminTab === 'orders' ? 'border-atl-orange text-atl-orange' : 'border-transparent text-gray-400 hover:text-gray-600'}`}
                    >
                      Orders ({orders.length})
                    </button>
                    <button 
                      onClick={() => setActiveAdminTab('users')}
                      className={`pb-2 px-4 font-bold text-sm transition-all border-b-2 whitespace-nowrap ${activeAdminTab === 'users' ? 'border-atl-orange text-atl-orange' : 'border-transparent text-gray-400 hover:text-gray-600'}`}
                    >
                      Users
                    </button>
                    <button 
                      onClick={() => setActiveAdminTab('settings')}
                      className={`pb-2 px-4 font-bold text-sm transition-all border-b-2 whitespace-nowrap ${activeAdminTab === 'settings' ? 'border-atl-orange text-atl-orange' : 'border-transparent text-gray-400 hover:text-gray-600'}`}
                    >
                      Settings
                    </button>
                  </div>
                  ...
                  {activeAdminTab === 'settings' && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-3">
                              {[0, 1, 2, 3, 4].map((idx) => (
                                <div key={idx} className="flex gap-2 items-center">
                                  ...
                                  />
                                  <label className="cursor-pointer p-1.5 bg-gray-100 rounded hover:bg-atl-orange hover:text-white transition-colors">
                                    <ImageIcon size={14} />
                                    <input 
                                      type="file" 
                                      className="hidden"
                          ...
                          <div>
                            ...
                            <div className="flex gap-2 mb-2">
                              <button 
                                ...
                                className={`flex-1 py-1 text-xs font-bold rounded ${siteConfig.heroBannerType === 'image' ? 'bg-atl-orange text-white' : 'bg-gray-200 text-gray-600'}`}
                              >
                                IMAGE
                              </button>
                              <button 
                                onClick={() => setSiteConfig({...siteConfig, heroBannerType: 'video'})}
                                className={`flex-1 py-1 text-xs font-bold rounded ${siteConfig.heroBannerType === 'video' ? 'bg-atl-orange text-white' : 'bg-gray-200 text-gray-600'}`}
                              >
                                VIDEO
                              </button>
                            </div>
                            <div className="space-y-3">
                              <label className="flex flex-col items-center justify-center gap-2 w-full py-6 border-2 border-dashed border-gray-200 rounded-xl cursor-pointer hover:border-atl-orange hover:bg-orange-50 transition-all group">
                                {siteConfig.heroBannerType === 'image' ? (
                                  <ImageIcon size={32} className="text-gray-400 group-hover:text-atl-orange" />
                                ) : (
                                  <VideoIcon size={32} className="text-gray-400 group-hover:text-atl-orange" />
                                )}
                                <div className="text-center">
                                  <p className="text-sm font-bold text-gray-600 group-hover:text-atl-orange">
                              ...
                              <div className="relative">
                                ...
                                <input 
                                  ...
                                  className="w-full border rounded-lg py-2 pl-9 pr-4 text-xs outline-none focus:ring-1 focus:ring-atl-orange"
                                />
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="bg-gray-50 p-6 rounded-xl">
                        ...
                        >
                          <h3 className="font-bold flex items-center gap-2 text-lg">
                            <Award size={20} className="text-atl-orange" />
                            Premium Offer Boxes
                          </h3>
                          <ChevronDown 
                            size={24} 
                            className={`text-gray-400 group-hover:text-atl-orange transition-transform duration-300 ${isPremiumOffersOpen ? 'rotate-180' : ''}`} 
                          />
                        </button>
                                ...
                                {siteConfig.premiumOffers?.map((offer, idx) => (
                                  <div key={idx} className="p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                                    <div className="flex justify-between items-center mb-3">
                                      <span className="text-xs font-bold text-atl-orange uppercase tracking-wider">Box {idx + 1}: {offer.title}</span>
                                      <div className="flex bg-gray-100 rounded-lg p-1">
                                        <button 
                                          ...
                                          className={`px-3 py-1 text-[10px] font-bold rounded-md transition-all ${offer.mode === 'auto' ? 'bg-white text-atl-orange shadow-sm' : 'text-gray-400'}`}
                                        >
                                          AUTO
                                        </button>
                                        <button 
                                          ...
                                          className={`px-3 py-1 text-[10px] font-bold rounded-md transition-all ${offer.mode === 'manual' ? 'bg-white text-atl-orange shadow-sm' : 'text-gray-400'}`}
                                        >
                                          MANUAL
                                        </button>
                                      </div>
                                          ...
                                          <div className="flex gap-2">
                                            ...
                                            <div className="relative">
                                              ...
                                              <input 
                                                ...
                                                className="text-[10px] border rounded pl-4 pr-1 py-0.5 w-24 outline-none focus:ring-1 focus:ring-atl-orange"
                                              />
                                            </div>
                                          </div>
                                        </div>
                                              ...
                                              return (
                                                <button
                                                  ...
                                                  className={`flex flex-col p-1.5 rounded-lg border transition-all text-left relative group ${
                                                    isSelected 
                                                      ? 'bg-orange-50 border-atl-orange ring-1 ring-atl-orange' 
                                                      : 'bg-white border-gray-200 hover:border-atl-orange'
                                                  }`}
                                                >
                                                  ...
                                                  <div className="flex justify-between items-center mt-0.5">
                                                    <span className="text-[8px] font-black text-atl-orange">৳{p.price}</span>
                                                  ...
                                                  {isSelected && (
                                                    <div className="absolute top-1 right-1 bg-atl-orange text-white rounded-full p-0.5 shadow-sm">
                                    ...
                                    {offer.mode === 'auto' && (
                                      <div className="p-2 bg-orange-50 rounded border border-orange-100 text-[10px] text-atl-orange italic">
                      ...
                      <div className="bg-gray-50 p-6 rounded-xl col-span-1 md:col-span-2">
                        ...
                        >
                          <h3 className="font-bold flex items-center gap-2 text-lg">
                            <Layout size={20} className="text-atl-orange" />
                            Footer Settings
                          </h3>
                          <ChevronDown 
                            size={24} 
                            className={`text-gray-400 group-hover:text-atl-orange transition-transform duration-300 ${isFooterSettingsOpen ? 'rotate-180' : ''}`} 
                          />
                        </button>
                                  ...
                                  <div key={sIdx} className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                                    <div className="flex justify-between items-center mb-3">
                                      <input 
                                        ...
                                        className="font-bold text-sm text-atl-orange uppercase outline-none focus:ring-1 focus:ring-atl-orange rounded px-1 w-full bg-orange-50/50"
                                      />
                                    </div>
                                    <div className="space-y-2">
                                      {section.links.map((link, lIdx) => (
                                        <div key={lIdx} className="flex gap-1 items-center">
                                          <input 
                                            ...
                                            className="text-xs border rounded p-1.5 w-full outline-none focus:ring-1 focus:ring-atl-orange bg-gray-50/50"
                                            placeholder="Label"
                                          />
                                          <button 
                                            onClick={() => {
                                      ...
                                      <button 
                                        ...
                                        className="text-[10px] font-bold text-atl-orange hover:underline flex items-center gap-1 mt-3 px-1"
                                      >
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                          ...
                          <tbody className="text-sm">
                            {orders.length === 0 ? (
                              <tr>
                                <td colSpan={6} className="p-12 text-center text-gray-400 italic">No orders found in the database.</td>
                              </tr>
                            ) : (
                              orders.map(order => (
                                <tr key={order.id} className="hover:bg-gray-50 transition-colors">
                                  ...
                                  <td className="p-4 border-b font-bold text-atl-orange">৳{order.totalAmount}</td>
                                  <td className="p-4 border-b">
                                    <select 
                                      value={order.status}
                                      onChange={async (e) => {
                                      ...
                                      className={`px-2 py-1 rounded-lg text-[10px] font-bold outline-none border ${
                                        ...
                                        order.status === 'processing' ? 'bg-yellow-50 text-yellow-600 border-yellow-200' :
                                  ...
                                  <td className="p-4 border-b">
                                    <button 
                                      ...
                                      className="text-atl-orange hover:underline text-xs font-bold"
                                    >
                                      Details
                                    </button>
                                  </td>
                  ...
                  {activeAdminTab === 'users' && (
                    <div className="space-y-6">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="text-sm text-gray-500">Registered Users: {registeredUsers.length}</div>
                      </div>
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {registeredUsers.map(user => (
                          <div key={user.id} className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex items-center gap-4">
                            ...
                            <div className="text-right">
                              <p className="text-[10px] font-bold text-atl-orange uppercase">Orders</p>
                              <p className="text-sm font-black">{user.totalOrders || 0}</p>
                            </div>
                          </div>
                        ))}
                      </div>
                        ...
                        <div className="flex gap-2 w-full sm:w-auto">
                          <div className="relative flex-1 sm:w-64">
                            ...
                            <input 
                              ...
                              className="w-full border rounded-lg py-2 pl-10 pr-4 text-sm outline-none focus:ring-1 focus:ring-atl-orange"
                            />
                          </div>
                          <button 
                            onClick={() => setIsAddingProduct(true)}
                            className="bg-atl-orange text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-orange-700 transition-colors flex items-center gap-2 whitespace-nowrap"
                          >
                            <Plus size={18} /> Add
                          </button>
                        </div>
        ...
        {isProfileOpen && currentUser && (
          ...
          >
            <div className="bg-white shadow-sm sticky top-0 z-10">
              <div className="atl-container py-4 flex items-center gap-4">
                <button 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                  <div className="bg-white rounded-2xl shadow-sm p-8 text-center">
                    <div className="relative inline-block mb-4 group">
                      <img 
                        ...
                        className="w-32 h-32 rounded-full border-4 border-atl-orange/10 p-1 object-cover"
                      />
                      <label className="absolute bottom-0 right-0 bg-atl-orange text-white p-2 rounded-full shadow-lg border-2 border-white cursor-pointer hover:bg-orange-700 transition-colors">
                        <Camera size={16} />
                        <input 
                          type="file" 
                          className="hidden" 
                    ...
                    {isEditingName ? (
                      <div className="flex items-center gap-2 mb-4">
                        <input 
                          ...
                          className="flex-1 border-2 border-atl-orange rounded-lg px-3 py-2 outline-none"
                          autoFocus
                        />
                        <button 
                          onClick={() => {
                          ...
                          className="bg-atl-orange text-white p-2 rounded-lg"
                        >
                          <Check size={20} />
                        </button>
                      </div>
                      ...
                      <div className="flex items-center justify-center gap-2 mb-1">
                        ...
                        <button 
                          ...
                          className="text-gray-400 hover:text-atl-orange"
                        >
                          <Edit2 size={16} />
                        </button>
                      </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-sm p-6">
                    <h3 className="font-bold mb-4 flex items-center gap-2">
                      <UserCircle size={18} className="text-atl-orange" />
                      Account Details
                    </h3>
                ...
                <div className="lg:col-span-2 space-y-6">
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div className="bg-white p-6 rounded-2xl shadow-sm text-center">
                      <div className="w-12 h-12 bg-orange-50 text-atl-orange rounded-full flex items-center justify-center mx-auto mb-3">
                        <ShoppingBag size={24} />
                      </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-sm p-8">
                    <div className="flex gap-6 border-b mb-6">
                      <button 
                        ...
                        className={`pb-2 font-bold text-sm transition-all border-b-2 ${activeProfileTab === 'profile' ? 'border-atl-orange text-atl-orange' : 'border-transparent text-gray-400 hover:text-gray-600'}`}
                      >
                        Activity Overview
                      </button>
                      <button 
                        onClick={() => setActiveProfileTab('orders')}
                        className={`pb-2 font-bold text-sm transition-all border-b-2 ${activeProfileTab === 'orders' ? 'border-atl-orange text-atl-orange' : 'border-transparent text-gray-400 hover:text-gray-600'}`}
                      >
                        My Orders
                      </button>
                    </div>
                      ...
                      <div className="space-y-6">
                        ...
                        {(currentUser.totalOrders || 0) === 0 ? (
                          <div className="text-center py-12 text-gray-400">
                            ...
                            <button 
                              onClick={() => setIsProfileOpen(false)}
                              className="mt-4 bg-atl-orange text-white px-6 py-2 rounded-full font-bold hover:bg-orange-700 transition-colors"
                            >
                              Start Shopping
                            </button>
                          </div>
                          ...
                          <div className="space-y-4">
                            <p className="text-gray-500 italic text-center py-4">Check the "My Orders" tab to see your order history and real-time status updates.</p>
                          </div>
                        )}
                      </div>
                    ) : (
                            ...
                            {orders.filter(o => o.userId === currentUser.id).map(order => (
                              <div key={order.id} className="border rounded-xl p-4 space-y-4 bg-gray-50/50">
                                <div className="flex justify-between items-start">
                                  <div>
                                    <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Order ID: {order.id}</p>
                                ...
                                <div className="pt-3 border-t flex justify-between items-center">
                                  ...
                                  <div className="text-right">
                                    ...
                                    <p className="text-lg font-black text-atl-orange">৳{order.totalAmount}</p>
                                  </div>
                                </div>
                              </div>
                            ))}
            ...
            <form className="space-y-4" onSubmit={(e) => {
              ...
              <div>
                ...
                <textarea 
                  ...
                  rows={6}
                  className="w-full border rounded p-2 text-sm focus:ring-1 focus:ring-atl-orange outline-none"
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <input 
                    ...
                    className="text-xs text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-atl-orange file:text-white hover:file:bg-orange-700 cursor-pointer"
                  />
                </div>
                <div className="mt-2">
